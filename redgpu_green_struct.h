...
REDGPU_DECLSPEC void REDGPU_API greenGetRedStructMember (const GreenStruct * structure, unsigned elementIndex, unsigned resourceHandlesCount, const void ** resourceHandles, RedStructMember * outRange, GreenStructMemberThrowaways * outRangeThrowawaysOfResourceHandlesCount);
